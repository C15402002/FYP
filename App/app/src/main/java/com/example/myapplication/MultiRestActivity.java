...
public class MultiRestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_rest);
...
//        restaurantId = (String) intent.getStringExtra( ScanActivity.QRCODE);
        ...
        button = findViewById(R.id.nearbyBtn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mapIntent = new Intent(MultiRestActivity.this, MapsActivity.class);
                ...
                protected void onBindViewHolder(@NonNull RestaurantHolder holder, int position, @NonNull Restaurant model) {
                    ...
                    holder.setItemClickListener(new ProductClickedListener() {
                        ...
                        public void onClick(View v, int pos, boolean isLongClicked) {
                            ...
                            Intent intent = new Intent(MultiRestActivity.this, HomeActivity.class);
